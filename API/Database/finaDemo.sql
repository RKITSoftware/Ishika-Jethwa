...
INSERT INTO `ook01` (`k01f02`, `k01f03`, `k01f04`, `k01f05`) VALUES ('Ishika', '2024-01-15', '2024-01-17', '1');
INSERT INTO `ook01` (`k01f02`, `k01f03`, `k01f04`, `k01f05`) VALUES ('Deven', '2024-01-20', '2024-01-21', '2');
...
GRANT SELECT, INSERT , UPDATE ON oom01 TO 'ishu'@'localhost';
GRANT SELECT , INSERT ,UPDATE ON ook01 TO 'ishu'@'localhost';

-- Revoke DELETE privilege on the oom01 table from a user
REVOKE DELETE ON oom01 FROM 'ishu'@'localhost';

REVOKE ALL PRIVILEGES ON *.* FROM 'ishu'@'localhost';
