...
namespace EmployeeService.Controllers
{
    ...
    public class EmployeesController : ApiController
    {
        ...
        {
            List<EmployeeTable> objEmployees = new List<EmployeeTable>();
            using (EmplyeeContext dbContext = new EmplyeeContext())
            {

                objEmployees = dbContext.EmployeeTables.ToList();
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK, objEmployees);
                }
            }
        }
