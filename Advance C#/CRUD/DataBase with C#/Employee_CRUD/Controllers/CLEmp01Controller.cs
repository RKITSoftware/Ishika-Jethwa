...
namespace Employee_CRUD.Controllers
{
    ...
    {
        private readonly BLEmp01 _objEmp = new BLEmp01();
        ...
        {
            return Ok(_objEmp.GetAllEmployees());
        }
        /// <summary>
        ...
        {
            return _objEmp.GetEmployeeById(id);
        }
        /// <summary>
        /// Adds a new employee.
        /// </summary>
        ...
        [HttpPost]
        [Route("AddEmployee")]
        public IHttpActionResult AddEmployee(DtoEmp01 objEmployee)
        {
        ...
        public IHttpActionResult UpdateEmployee(DtoEmp01 objEmployee)
        {
